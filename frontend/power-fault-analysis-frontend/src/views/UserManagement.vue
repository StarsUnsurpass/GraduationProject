<template>
  <div class="user-management-container">
      ...
      <el-table-column label="操作" width="150">
        <template #default="scope">
          <el-popconfirm title="确定删除该用户吗？" @confirm="deleteUser(scope.row.username)">
            <template #reference>
              <el-button type="danger" size="small" :disabled="scope.row.username === 'admin'">删除</el-button>
            </template>
          </el-popconfirm>
        </template>
      </el-table-column>
    ...
    <!-- Add User Dialog -->
    <el-dialog v-model="showAddDialog" title="添加新用户" width="30%">
